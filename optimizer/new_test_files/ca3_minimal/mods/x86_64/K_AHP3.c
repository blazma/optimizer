...
#define nrn_init _nrn_init__K_AHP3
#define _nrn_initial _nrn_initial__K_AHP3
#define nrn_cur _nrn_cur__K_AHP3
#define _nrn_current _nrn_current__K_AHP3
#define nrn_jacob _nrn_jacob__K_AHP3
#define nrn_state _nrn_state__K_AHP3
#define _net_receive _net_receive__K_AHP3 
#define settables settables__K_AHP3 
#define states states__K_AHP3 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_K_AHP3", _hoc_setdata,
 "settables_K_AHP3", _hoc_settables,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_AHP3 /home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/K_AHP3.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   settables ( _threadargscomma_ v , cai ) ;
   Dm = ( minf - m ) / mtau ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/K_AHP3.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
