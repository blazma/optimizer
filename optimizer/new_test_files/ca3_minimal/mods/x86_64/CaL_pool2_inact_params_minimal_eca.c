...
#define nrn_init _nrn_init__CaL_pool2_inact_params_minimal_eca
#define _nrn_initial _nrn_initial__CaL_pool2_inact_params_minimal_eca
#define nrn_cur _nrn_cur__CaL_pool2_inact_params_minimal_eca
#define _nrn_current _nrn_current__CaL_pool2_inact_params_minimal_eca
#define nrn_jacob _nrn_jacob__CaL_pool2_inact_params_minimal_eca
#define nrn_state _nrn_state__CaL_pool2_inact_params_minimal_eca
#define _net_receive _net_receive__CaL_pool2_inact_params_minimal_eca 
#define _f_rates _f_rates__CaL_pool2_inact_params_minimal_eca 
#define rates rates__CaL_pool2_inact_params_minimal_eca 
#define states states__CaL_pool2_inact_params_minimal_eca 
...
#define Y_k0 _p[2]
#define Y_tau0 _p[3]
#define A_alpha_X _p[4]
#define B_alpha_X _p[5]
#define Vhalf_alpha_X _p[6]
#define A_beta_X _p[7]
#define B_beta_X _p[8]
#define Vhalf_beta_X _p[9]
#define gion _p[10]
#define Xinf _p[11]
#define Xtau _p[12]
#define Yinf _p[13]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaL_pool2_inact_params_minimal_eca", _hoc_setdata,
 "rates_CaL_pool2_inact_params_minimal_eca", _hoc_rates,
 0, 0
};
...
#define cai cai_CaL_pool2_inact_params_minimal_eca
 double cai = 0;
#define usetable usetable_CaL_pool2_inact_params_minimal_eca
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_CaL_pool2_inact_params_minimal_eca", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "cai_CaL_pool2_inact_params_minimal_eca", "mM",
 "gmax_CaL_pool2_inact_params_minimal_eca", "S/cm2",
 "Y_v0_CaL_pool2_inact_params_minimal_eca", "mV",
 "Y_k0_CaL_pool2_inact_params_minimal_eca", "mV",
 "Y_tau0_CaL_pool2_inact_params_minimal_eca", "ms",
 "A_alpha_X_CaL_pool2_inact_params_minimal_eca", "1/ms",
 "B_alpha_X_CaL_pool2_inact_params_minimal_eca", "mV",
 "Vhalf_alpha_X_CaL_pool2_inact_params_minimal_eca", "mV",
 "A_beta_X_CaL_pool2_inact_params_minimal_eca", "1/ms",
 "B_beta_X_CaL_pool2_inact_params_minimal_eca", "mV",
 "Vhalf_beta_X_CaL_pool2_inact_params_minimal_eca", "mV",
 "gion_CaL_pool2_inact_params_minimal_eca", "S/cm2",
 "Xtau_CaL_pool2_inact_params_minimal_eca", "ms",
 "Ytau_CaL_pool2_inact_params_minimal_eca", "ms",
 0,0
};
 static double X0 = 0;
 static double Y0 = 0;
 ...
 "cai_CaL_pool2_inact_params_minimal_eca", &cai_CaL_pool2_inact_params_minimal_eca,
 "usetable_CaL_pool2_inact_params_minimal_eca", &usetable_CaL_pool2_inact_params_minimal_eca,
 0,0
};
...
#define _cvode_ieq _ppvar[3]._i
 ...
 "7.7.0",
"CaL_pool2_inact_params_minimal_eca",
 "gmax_CaL_pool2_inact_params_minimal_eca",
 "Y_v0_CaL_pool2_inact_params_minimal_eca",
 "Y_k0_CaL_pool2_inact_params_minimal_eca",
 "Y_tau0_CaL_pool2_inact_params_minimal_eca",
 "A_alpha_X_CaL_pool2_inact_params_minimal_eca",
 "B_alpha_X_CaL_pool2_inact_params_minimal_eca",
 "Vhalf_alpha_X_CaL_pool2_inact_params_minimal_eca",
 "A_beta_X_CaL_pool2_inact_params_minimal_eca",
 "B_beta_X_CaL_pool2_inact_params_minimal_eca",
 "Vhalf_beta_X_CaL_pool2_inact_params_minimal_eca",
 0,
 "gion_CaL_pool2_inact_params_minimal_eca",
 "Xinf_CaL_pool2_inact_params_minimal_eca",
 "Xtau_CaL_pool2_inact_params_minimal_eca",
 "Yinf_CaL_pool2_inact_params_minimal_eca",
 "Ytau_CaL_pool2_inact_params_minimal_eca",
 0,
 "X_CaL_pool2_inact_params_minimal_eca",
 "Y_CaL_pool2_inact_params_minimal_eca",
 0,
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _CaL_pool2_inact_params_minimal_eca_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", 2.0);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaL_pool2_inact_params_minimal_eca /home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/CaL_pool2_inact_params_minimal_eca.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_X ;
  _ltemp_adj_X = 1.0 ;
   _lalpha = A_alpha_X * exp ( ( _lv - Vhalf_alpha_X ) / B_alpha_X ) ;
   _lbeta = A_beta_X * exp ( ( _lv - Vhalf_beta_X ) / B_beta_X ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/CaL_pool2_inact_params_minimal_eca.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
  ...
  "      \n"
  "\n"
  "    SUFFIX CaL_pool2_inact_params_minimal_eca\n"
