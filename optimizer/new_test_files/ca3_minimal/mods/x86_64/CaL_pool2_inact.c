...
#define nrn_init _nrn_init__CaL_pool2_inact
#define _nrn_initial _nrn_initial__CaL_pool2_inact
#define nrn_cur _nrn_cur__CaL_pool2_inact
#define _nrn_current _nrn_current__CaL_pool2_inact
#define nrn_jacob _nrn_jacob__CaL_pool2_inact
#define nrn_state _nrn_state__CaL_pool2_inact
#define _net_receive _net_receive__CaL_pool2_inact 
#define _f_rates _f_rates__CaL_pool2_inact 
#define rates rates__CaL_pool2_inact 
#define states states__CaL_pool2_inact 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaL_pool2_inact", _hoc_setdata,
 "h2_CaL_pool2_inact", _hoc_h2,
 "rates_CaL_pool2_inact", _hoc_rates,
 0, 0
};
#define h2 h2_CaL_pool2_inact
...
#define Y_tau0 Y_tau0_CaL_pool2_inact
 double Y_tau0 = 484;
#define Y_k0 Y_k0_CaL_pool2_inact
 double Y_k0 = -5.7;
#define Y_v0 Y_v0_CaL_pool2_inact
 double Y_v0 = -8.4;
#define usetable usetable_CaL_pool2_inact
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_CaL_pool2_inact", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Y_v0_CaL_pool2_inact", "mV",
 "Y_k0_CaL_pool2_inact", "mV",
 "Y_tau0_CaL_pool2_inact", "ms",
 "gmax_CaL_pool2_inact", "S/cm2",
 "ki_CaL_pool2_inact", "mM",
 "gion_CaL_pool2_inact", "S/cm2",
 "Xtau_CaL_pool2_inact", "ms",
 "Ytau_CaL_pool2_inact", "ms",
 0,0
};
 static double X0 = 0;
 static double Y0 = 0;
 ...
 "Y_v0_CaL_pool2_inact", &Y_v0_CaL_pool2_inact,
 "Y_k0_CaL_pool2_inact", &Y_k0_CaL_pool2_inact,
 "Y_tau0_CaL_pool2_inact", &Y_tau0_CaL_pool2_inact,
 "usetable_CaL_pool2_inact", &usetable_CaL_pool2_inact,
 0,0
};
...
#define _cvode_ieq _ppvar[5]._i
 ...
 "7.7.0",
"CaL_pool2_inact",
 "gmax_CaL_pool2_inact",
 "ki_CaL_pool2_inact",
 0,
 "gion_CaL_pool2_inact",
 "Xinf_CaL_pool2_inact",
 "Xtau_CaL_pool2_inact",
 "Yinf_CaL_pool2_inact",
 "Ytau_CaL_pool2_inact",
 0,
 "X_CaL_pool2_inact",
 "Y_CaL_pool2_inact",
 0,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaL_pool2_inact /home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/CaL_pool2_inact.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gion = gmax * ( pow( ( X ) , 2.0 ) ) * Y * h2 ( _threadargscomma_ cai ) ;
   ica = gion * ( v - eca ) ;
   ical = ica ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/CaL_pool2_inact.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
