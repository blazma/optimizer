...
#define nrn_init _nrn_init__CaL_pool2_inact_params_minimal
#define _nrn_initial _nrn_initial__CaL_pool2_inact_params_minimal
#define nrn_cur _nrn_cur__CaL_pool2_inact_params_minimal
#define _nrn_current _nrn_current__CaL_pool2_inact_params_minimal
#define nrn_jacob _nrn_jacob__CaL_pool2_inact_params_minimal
#define nrn_state _nrn_state__CaL_pool2_inact_params_minimal
#define _net_receive _net_receive__CaL_pool2_inact_params_minimal 
#define _f_rates _f_rates__CaL_pool2_inact_params_minimal 
#define rates rates__CaL_pool2_inact_params_minimal 
#define states states__CaL_pool2_inact_params_minimal 
...
#define _ion_ical	*_ppvar[3]._pval
#define _ion_dicaldv	*_ppvar[4]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaL_pool2_inact_params_minimal", _hoc_setdata,
 "rates_CaL_pool2_inact_params_minimal", _hoc_rates,
 0, 0
};
...
#define usetable usetable_CaL_pool2_inact_params_minimal
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_CaL_pool2_inact_params_minimal", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_CaL_pool2_inact_params_minimal", "S/cm2",
 "Y_v0_CaL_pool2_inact_params_minimal", "mV",
 "Y_k0_CaL_pool2_inact_params_minimal", "mV",
 "Y_tau0_CaL_pool2_inact_params_minimal", "ms",
 "A_alpha_X_CaL_pool2_inact_params_minimal", "1/ms",
 "B_alpha_X_CaL_pool2_inact_params_minimal", "mV",
 "Vhalf_alpha_X_CaL_pool2_inact_params_minimal", "mV",
 "A_beta_X_CaL_pool2_inact_params_minimal", "1/ms",
 "B_beta_X_CaL_pool2_inact_params_minimal", "mV",
 "Vhalf_beta_X_CaL_pool2_inact_params_minimal", "mV",
 "gion_CaL_pool2_inact_params_minimal", "S/cm2",
 "Xtau_CaL_pool2_inact_params_minimal", "ms",
 "Ytau_CaL_pool2_inact_params_minimal", "ms",
 0,0
};
 static double X0 = 0;
 static double Y0 = 0;
 ...
 "usetable_CaL_pool2_inact_params_minimal", &usetable_CaL_pool2_inact_params_minimal,
 0,0
};
...
#define _cvode_ieq _ppvar[5]._i
 ...
 "7.7.0",
"CaL_pool2_inact_params_minimal",
 "gmax_CaL_pool2_inact_params_minimal",
 "Y_v0_CaL_pool2_inact_params_minimal",
 "Y_k0_CaL_pool2_inact_params_minimal",
 "Y_tau0_CaL_pool2_inact_params_minimal",
 "A_alpha_X_CaL_pool2_inact_params_minimal",
 "B_alpha_X_CaL_pool2_inact_params_minimal",
 "Vhalf_alpha_X_CaL_pool2_inact_params_minimal",
 "A_beta_X_CaL_pool2_inact_params_minimal",
 "B_beta_X_CaL_pool2_inact_params_minimal",
 "Vhalf_beta_X_CaL_pool2_inact_params_minimal",
 0,
 "gion_CaL_pool2_inact_params_minimal",
 "Xinf_CaL_pool2_inact_params_minimal",
 "Xtau_CaL_pool2_inact_params_minimal",
 "Yinf_CaL_pool2_inact_params_minimal",
 "Ytau_CaL_pool2_inact_params_minimal",
 0,
 "X_CaL_pool2_inact_params_minimal",
 "Y_CaL_pool2_inact_params_minimal",
 0,
 0};
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_cal_sym);
 	_ppvar[3]._pval = &prop_ion->param[3]; /* ical */
 	_ppvar[4]._pval = &prop_ion->param[4]; /* _ion_dicaldv */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _CaL_pool2_inact_params_minimal_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", 2.0);
 	ion_reg("cal", 2.0);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaL_pool2_inact_params_minimal /home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/CaL_pool2_inact_params_minimal.mod\n");
...
static void _ode_matsol(_NrnThread* _nt, _Memb_list* _ml, int _type) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_cal_sym, _ppvar, 3, 3);
   nrn_update_ion_pointer(_cal_sym, _ppvar, 4, 4);
 }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/optimizer_20220509/ca3_minimal_for_pygmo/mods/CaL_pool2_inact_params_minimal.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
