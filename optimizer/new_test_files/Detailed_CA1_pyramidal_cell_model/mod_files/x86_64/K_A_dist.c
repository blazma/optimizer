...
#define nrn_init _nrn_init__K_A_dist
#define _nrn_initial _nrn_initial__K_A_dist
#define nrn_cur _nrn_cur__K_A_dist
#define _nrn_current _nrn_current__K_A_dist
#define nrn_jacob _nrn_jacob__K_A_dist
#define nrn_state _nrn_state__K_A_dist
#define _net_receive _net_receive__K_A_dist 
#define _f_rates _f_rates__K_A_dist 
#define rates rates__K_A_dist 
#define states states__K_A_dist 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_K_A_dist", _hoc_setdata,
 "rates_K_A_dist", _hoc_rates,
 0, 0
};
...
#define usetable usetable_K_A_dist
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_K_A_dist", 0, 1,
 0,0,0
};
 ...
 "usetable_K_A_dist", &usetable_K_A_dist,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_A_dist /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Detailed_CA1_pyramidal_cell_model/mod_files/K_A_dist.mod\n");
...
static int _reset;
static char *modelname = "Channel: K_A_dist";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalpha , _lbeta , _ltau , _linf , _lgamma , _lzeta , _ltemp_adj_X , _lA_alpha_X , _lB_alpha_X , _lVhalf_alpha_X , _lA_beta_X , _lB_beta_X , _lVhalf_beta_X , _ltemp_adj_Y , _lA_tau_Y , _lB_tau_Y , _lVhalf_tau_Y , _lA_inf_Y , _lB_inf_Y , _lVhalf_inf_Y ;
  _ltemp_adj_X = 1.0 ;
   _ltemp_adj_Y = 1.0 ;
   _lA_alpha_X = 450.0 ;
   _lB_alpha_X = 0.024 ;
   _lVhalf_alpha_X = - 0.0165 ;
   ...
   _lv = _lv * 0.0010 ;
   _linf = 1.0 / ( 1.0 + ( exp ( 125.0 * ( _lv + 0.051 ) ) ) ) ;
   _lv = _lv * 1000.0 ;
   Yinf = _linf ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Detailed_CA1_pyramidal_cell_model/mod_files/K_A_dist.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
  ...
  "   K_A_dist (Type: Channel mechanism, Model: ChannelML based process)\n"
  "\n"
  "   with parameters: \n"
  "   /channelml/@units = SI Units \n"
  "   /channelml/notes = ChannelML file containing a single Channel description \n"
  "   /channelml/channel_type/@name = K_A_dist \n"
  ...
  "   /channelml/channel_type/current_voltage_relation/gate[1]/transition[1]/@midpoint = -0.0165 \n"
  ...
  "   /channelml/channel_type/current_voltage_relation/gate[1]/transition[2]/@midpoint = -0.0165 \n"
  ...
  "\n"
  "// File from which this was generated: /home/kali/nC_projects/CA1_NEURON/cellMechanisms/K_A_dist/K_A_dist.xml\n"
  "\n"
  "// XSL file with mapping to simulator: /home/kali/nC_projects/CA1_NEURON/cellMechanisms/K_A_dist/ChannelML_v1.8.1_NEURONmod.xsl\n"
  "\n"
  "ENDCOMMENT\n"
  "\n"
  "\n"
