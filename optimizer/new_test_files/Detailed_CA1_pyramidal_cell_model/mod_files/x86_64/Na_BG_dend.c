...
#define nrn_init _nrn_init__Na_BG_dend
#define _nrn_initial _nrn_initial__Na_BG_dend
#define nrn_cur _nrn_cur__Na_BG_dend
#define _nrn_current _nrn_current__Na_BG_dend
#define nrn_jacob _nrn_jacob__Na_BG_dend
#define nrn_state _nrn_state__Na_BG_dend
#define _net_receive _net_receive__Na_BG_dend 
#define _f_rates _f_rates__Na_BG_dend 
#define rates rates__Na_BG_dend 
#define states states__Na_BG_dend 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Na_BG_dend", _hoc_setdata,
 "rates_Na_BG_dend", _hoc_rates,
 0, 0
};
...
#define usetable usetable_Na_BG_dend
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_Na_BG_dend", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_Na_BG_dend", "S/cm2",
 "gion_Na_BG_dend", "S/cm2",
 "Xtau_Na_BG_dend", "ms",
 "Ytau_Na_BG_dend", "ms",
 "Ztau_Na_BG_dend", "ms",
 0,0
 ...
 "usetable_Na_BG_dend", &usetable_Na_BG_dend,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na_BG_dend /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Detailed_CA1_pyramidal_cell_model/mod_files/Na_BG_dend.mod\n");
...
static int _reset;
static char *modelname = "Channel: Na_BG_dend";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Detailed_CA1_pyramidal_cell_model/mod_files/Na_BG_dend.mod";
static const char* nmodl_file_text = 
