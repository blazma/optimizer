...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cacum /home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Detailed_CA1_pyramidal_cell_model/mod_files/cacum.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcai = - ica / depth / F / 2.0 * ( 1e7 ) + ( cai0 - cai ) / tau ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mohacsi/Desktop/optimizer/optimizer/new_test_files/Detailed_CA1_pyramidal_cell_model/mod_files/cacum.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
