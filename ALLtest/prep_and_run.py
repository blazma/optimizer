...
optimizer_path 	= '/home/mohacsi/Desktop/optimizer/optimizer/neuroptimus.py'
...
rnd_start  = 1233							# random seed in the first run
...
def EditXMLs(evo_name,evo_strat):
	for i in range(1,num_runs+1):
		...
		if os.path.exists(subdir):
			...
			root.find('current_algorithm').text		= str(evo_strat)
			tree.write(xml_name)
